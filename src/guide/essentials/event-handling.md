...
2. 2. **Manejadores de método:** Un nombre de propiedad o ruta que apunta a un método definido en el componente.
...
<!-- el comportamiento por defecto del evento scroll (desplazamiento) se producirá -->
