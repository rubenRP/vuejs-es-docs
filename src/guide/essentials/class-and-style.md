...
Por ejemplo, si tenemos un componente llamado `my-component` con la siguiente template:
...
```vue-html
<!-- template de my-component usando $attrs -->
...
Puedes aprender más sobre la herencia de atributos de los componentes en la sección [Atributos no Props](/guide/components/attrs.html).
