...
Las expresiones en las templates son muy convenientes, pero están pensadas para operaciones simples. Poner demasiada lógica en tus templates puede hacerlas infladas y difíciles de mantener. Por ejemplo, si tenemos un objeto con un array anidado:
